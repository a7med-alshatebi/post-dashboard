              ...
              <h3 className={`text-lg font-bold text-gray-900 dark:text-white flex items-center gap-3 ${isRTL ? 'flex-row-reverse text-right' : 'text-left'}`}>
                {isRTL ? (
                  <>
                    ...
                    <span className="text-right w-full block">{t('settings.displaySettings')}</span>
                  </>
                ) : (
                  <>
                    <span>{t('settings.displaySettings')}</span>
                    <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
              ...
              <h3 className={`text-lg font-bold text-gray-900 dark:text-white flex items-center gap-3 ${isRTL ? 'flex-row-reverse text-right' : 'text-left'}`}>
                {isRTL ? (
                  <>
                    ...
                    <span className="text-right w-full block">{t('settings.autoRefreshSettings')}</span>
                  </>
                ) : (
                  <>
                    <span>{t('settings.autoRefreshSettings')}</span>
                    <div className="w-8 h-8 bg-gradient-to-br from-green-500 to-blue-500 rounded-lg flex items-center justify-center">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                      </svg>
              ...
              <h3 className={`text-lg font-bold text-gray-900 dark:text-white flex items-center gap-3 ${isRTL ? 'flex-row-reverse text-right' : 'text-left'}`}>
                {isRTL ? (
                  <>
                    ...
                    <span className="text-right w-full block">{t('settings.notifications')}</span>
                  </>
                ) : (
                  <>
              ...
              <h3 className={`text-lg font-bold text-gray-900 dark:text-white flex items-center gap-3 ${isRTL ? 'flex-row-reverse text-right' : 'text-left'}`}>
                {isRTL ? (
                  <>
                    ...
                    <span className="text-right w-full block">{t('settings.localization')}</span>
                  </>
                ) : (
                  <>
